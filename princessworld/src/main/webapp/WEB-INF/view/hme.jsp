...
<style>
  body {
    background:url('resources/images/snowy.jpg');
	...
	<div id="myCarousel" class="carousel slide">
		...
		<div class="carousel-inner">
			...
			<div class="item active">
				<div class="fill">
					<img src="<c:url value='/resources/images/neha.jpg'/>"
						class="center-block" alt="fashion" width="1200" height="548">
			...
			<div class="item">
				<div class="fill">
					<img src="<c:url value='/resources/images/dresses.jpg'/>"
						class="center-block" alt="fashion" width="1200" height="548">
					<div class="carousel-caption"></div>
				</div>
			</div>
			...
			<div class="item">
				<div class="fill">
					<img src="<c:url value='/resources/images/grt.jpg'/>"
						class="center-block" alt="Fashion" width="1200" height="548">
					<div class="carousel-caption"></div>
				</div>
			</div>
