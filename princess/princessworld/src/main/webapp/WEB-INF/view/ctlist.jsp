...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
     ...
     <tr>
      ...
      <td><a href="ctedit?id=${category.catid}" class="btn btn-success custom-width">Edit</a></td>
      <td><a href="deleteCategory?id=${category.catid}" class="btn btn-danger custom-width">Delete</a></td>
     </tr>
    </c:forEach> 
    <tbody>
   </table>
